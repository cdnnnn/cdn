...
// stay constant across themes. $solid is a FIXED near-black used only for
// "always dark chip" buttons (Connect/Add Provider) — using themed $ink
// here would make them turn near-white (and invisible) in dark mode.
// ===========================================================================
...
// fixed, non-themed — always a dark chip regardless of light/dark mode
$solid: #14161B;
$solid-hover: #000000;
...
// ---- nav item ---------------------------------------------------------
// Active state is a SOLID signal pill (not a wash tint) — a filled pill
// with white text reads clearly in both light and dark mode; a low-opacity
// wash background with colored text can look washed-out/low-contrast on
// dark surfaces.
.nav-item {
  display: flex;
  align-items: center;
