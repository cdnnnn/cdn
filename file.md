 ...
 * and a floating menu with accent dots, a check on the active row, and
 * hover/keyboard states.
 */
export default function TicketSelect({
  ...
  return (
    <div className={styles['select']} ref={rootRef}>
      ...
      {open && (
        <div className={styles['select-menu']} role="listbox">
          ...
          {options.map((o) => {
            ...
            return (
              <button
                ...
                className={`${styles['select-option']} ${active ? styles['select-option--active'] : ''}`}
