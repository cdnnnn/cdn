                                        ...
                                        <tr key={tpl.id}>
                                            ...
                                            <td>
                                                <div className={styles.rowActs}>
                                                    {tpl.is_default ? (
                                                        // Default templates are read-only — show an info icon tooltip
                                                        <span
                                                            className={styles.defaultInfo}
                                                            title={t('promptTemplates.table.defaultTooltip')}
                                                            aria-label={t('promptTemplates.table.defaultTooltip')}
                                                        ...
                                                        >
                                                            ...
                                                            {t('promptTemplates.table.defaultInfo')}
                                                        </span>
                                                    ) : (
                                                        <>
                                                            <button
...
.textarea {
  resize: vertical;
  min-height: 80px;   // gives the drag handle room; users can pull taller
  max-height: 320px;  // prevents runaway growth in a constrained modal
  line-height: 1.5;
  @include m.mono;
  font-size: 12px;
}
