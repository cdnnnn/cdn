                                        ...
                                        <div className={styles['ev__dcard-top']}>
                                          ...
                                          <div className={styles['ev__dcard-actions']}>
                                            <button
                                              ...
                                              onClick={(e) => {
                                                e.stopPropagation();
                                                openPreview(d.id, d.name, d.question_count);
                                              }}
...
export const evaluationsApi = {
  ...
  // 20 questions per page by default. Total page count is derived on the
  // caller's side from the dataset's own `question_count` (from the
  // /datasets list), not from this response.
