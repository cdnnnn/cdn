...
// Registering --history-angle as a real <angle> custom property is what
// lets the browser smoothly interpolate it frame-by-frame instead of
// snapping — this must live at the CSS top level, not nested inside a
// selector, or it won't register at all.
