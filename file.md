...
const UploadInfer: React.FC = () => {
  ...
  const allTourSteps: TourStep[] = [
    ...
    {
      target: 'infer-check-keywordinsights',
      title: t('uploadInfer.tour.checkKeywordInsightsTitle', 'Keyword Insights'),
      content: t('uploadInfer.tour.checkKeywordInsightsBody', 'An optional add-on to Keywords \u2014 builds extra visualizations from the extracted terms, like a word cloud and knowledge graph, in the Results tab.'),
      onEnter: () => setActiveTab('infer'),
    },
    {
    ...
    },
    {
      ...
      title: t('uploadInfer.tour.resultsToolbarTitle', 'Edit, copy, or download'),
      content: t('uploadInfer.tour.resultsToolbarBody', 'Every tab has this toolbar: edit the content directly (where editable), copy it in a chosen format, or download it as a file \u2014 Text, Markdown, HTML, or JSON.'),
      placement: 'left',
      onEnter: () => { setActiveTab('results'); workspacePanelRef.current?.setTab('summary'); },
    },
  ];
...
const TabToolbar: React.FC<{
    ...
    const { t } = useTranslation();
    return (
        <div className={styles.tabToolbar} data-tour="results-toolbar">
...

{
  ...
  "uploadInfer": {
    ...
    "tour": {
      ...
      "checkKeywordInsightsTitle": "Keyword Insights",
      "checkKeywordInsightsBody": "An optional add-on to Keywords — builds extra visualizations from the extracted terms, like a word cloud and knowledge graph, in the Results tab.",
      ...
      "resultsToolbarTitle": "Edit, copy, or download",
      "resultsToolbarBody": "Every tab has this toolbar: edit the content directly (where editable), copy it in a chosen format, or download it as a file — Text, Markdown, HTML, or JSON."
    },
    "batchGroups": {
      "batchTitle": "Batch #{{id}}",
...

{
  ...
  "uploadInfer": {
    ...
    "tour": {
      ...
      "checkKeywordInsightsTitle": "키워드 인사이트",
      "checkKeywordInsightsBody": "키워드 기능에 대한 선택적 추가 기능입니다 — 추출된 용어를 바탕으로 워드클라우드, 지식 그래프 등 결과 탭에서 볼 수 있는 추가 시각화 자료를 만듭니다.",
      ...
      "resultsToolbarTitle": "편집, 복사, 다운로드",
      "resultsToolbarBody": "모든 탭에는 이 도구모음이 있습니다: 편집 가능한 경우 콘텐츠를 직접 수정하거나, 원하는 형식으로 복사하거나, 파일로 다운로드할 수 있습니다 — 텍스트, 마크다운, HTML, JSON 중에서 선택하세요."
    },
    "batchGroups": {
      "batchTitle": "배치 #{{id}}",
      "done": "{{done}} / {{total}} 완료",
