            ...
            {!isBatchRunning && !running && <div className={styles.infSettingsWrap} data-tour="infer-settings">
              <div className={styles.settingsGrid}>
                ...
                <div className={styles.card}>
                  ...
                  <div
                    className={`${styles.cr} ${settings.generateSummary ? styles.ck : ''} ${styles.mb8} ${n === 0 ? styles.crDisabled : ''}`}
                    aria-disabled={n === 0}
                    onClick={() => { if (n === 0) return; dispatch(updateSettings({ generateSummary: !settings.generateSummary })); }}
                  >
                  ...
                  <div className={styles.fieldCell}>
                  <div
                    className={`${styles.cr} ${settings.generateKeywords ? styles.ck : ''} ${styles.mb8} ${n === 0 ? styles.crDisabled : ''}`}
                    aria-disabled={n === 0}
                    onClick={() => {
                      if (n === 0) return;
                      dispatch(updateSettings({
                  ...
                  {settings.generateKeywords && (
                    <div
                      className={`${styles.crNested} ${settings.generateKeywordInsights ? styles.ck : ''} ${styles.mb8} ${n === 0 ? styles.crDisabled : ''}`}
                      aria-disabled={n === 0}
                      onClick={(e) => { e.stopPropagation(); if (n === 0) return; dispatch(updateSettings({ generateKeywordInsights: !settings.generateKeywordInsights })); }}
                    >
                  ...
                  <div className={styles.fieldCell}>
                  <div
                    className={`${styles.cr} ${settings.generateQuestions ? styles.ck : ''} ${styles.mb8} ${n === 0 ? styles.crDisabled : ''}`}
                    aria-disabled={n === 0}
                    onClick={() => { if (n === 0) return; dispatch(updateSettings({ generateQuestions: !settings.generateQuestions })); }}
                  >
                  ...
                  <div className={styles.fieldCell}>
                  <div
                    className={`${styles.cr} ${settings.generateShortAnswer ? styles.ck : ''} ${styles.mb8} ${n === 0 ? styles.crDisabled : ''}`}
                    aria-disabled={n === 0}
                    onClick={() => { if (n === 0) return; dispatch(updateSettings({ generateShortAnswer: !settings.generateShortAnswer })); }}
                  >
                  ...
                  <div className={styles.fieldCell}>
                  <div
                    className={`${styles.cr} ${settings.generateTrueFalse ? styles.ck : ''} ${styles.mb8} ${n === 0 ? styles.crDisabled : ''}`}
                    aria-disabled={n === 0}
                    onClick={() => { if (n === 0) return; dispatch(updateSettings({ generateTrueFalse: !settings.generateTrueFalse })); }}
                  >
                  ...
                  <div className={styles.fieldCell}>
                  <div
                    className={`${styles.cr} ${settings.timestampedSummary ? styles.ck : ''} ${styles.mb8} ${n === 0 ? styles.crDisabled : ''}`}
                    aria-disabled={n === 0}
                    onClick={() => { if (n === 0) return; dispatch(updateSettings({ timestampedSummary: !settings.timestampedSummary })); }}
                  >
...
// Shared disabled state for .cr / .crNested — used while no files are
// selected, since there's nothing for these settings to apply to yet.
.crDisabled {
  cursor: not-allowed;
  opacity: 0.45;
          ...
          <div className={styles.section2TitleRow}>
            ...
            <div className={styles.dateFilter}>
              <span className={styles.sortHeaderLabel}>
                ...
                {t('uploadInfer.filePanel.dateRangeLabel', 'Date Range')}
              </span>
            ...
            <div className={styles.statusFilterWrap}>
              <span className={styles.sortHeaderLabel}>
                ...
                {t('uploadInfer.filePanel.statusLabel', 'Status')}
              </span>
              <select
...
// Compact S·K·Q·A·T checklist — which content prompts are customized
// for this file (Summary, Keywords, Questions, short Answer, True/false).
.fcardPrompts {
  display: flex;
  align-items: center;
  gap: 3px;
