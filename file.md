...
.hero-bg-dots {
  position: absolute; inset: 0; background-image: radial-gradient(circle, $line 1px, transparent 1px);
  background-size: 24px 24px; opacity: 0.6; pointer-events: none; animation: dotPulse 4s ease infinite;
}
