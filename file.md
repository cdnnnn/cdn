...
//     the selected Test Suite dataset's name is 'new_live' or 'new_mdeval'
//     (see CODE_EXECUTION_DATASET_NAMES), useCodeExecution is true and it
//     calls GET /code-execution-metrics instead — same response shape.
...
const CODE_EXECUTION_DATASET_NAMES = new Set(['new_live', 'new_mdeval']);
