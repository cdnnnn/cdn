...
const STAGE = [
  ...
  { title: 'Choose models', sub: 'Add every model you want scored side by side in this run.' },
    ...
    <div className="page-enter" style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      <div className={styles.page}>
        <div className={styles.ev}>
          {/* ---- top bar ---- */}
          <div className={styles.ev__topbar}>
            <div className={styles.ev__brand}>
              <span className={styles['ev__brand-mark']}>
                <Workflow size={18} />
              </span>
              <div className={styles['ev__brand-text']}>
                <span className={styles.ev__eyebrow}>Evaluation console</span>
                <span className={styles['ev__brand-title']}>New run</span>
              </div>
            </div>
            <div className={styles.ev__topmeta}>
              <span className={styles.ev__status} data-state={launching ? 'live' : 'draft'}>
                {launching ? 'Launching' : 'Draft'}
              </span>
              <span className={styles.ev__eta}>
                      ...
                      {draft.eval_type === 'Agent' && (
                        <div className={styles.ev__section}>
                          <label className={styles.ev__label}>
                            <Workflow size={13} /> Agent framework <span className="opt">optional</span>
                          </label>
                      ...
                      <div className={styles['ev__metrics-main']}>
                        ...
                        <div className={styles['ev__metrics-bar']}>
                          <span className={styles['ev__metrics-count']}>
                            <b>{draft.selMetrics.length}</b> of {activeMetricsList.length} selected
                          </span>
                        ...
                        <div className={styles.ev__chips}>
                          ...
                          {activeMetricsList.length === 0 && <p className={styles.ev__empty}>No metrics available for this type.</p>}
                        </div>
                      </div>
...
// ---- local design tokens (self-contained; only fonts come from the theme) --
$ink:      #14161B;
$ink-2:    #565B66;
$ink-3:    #8A909B;
$paper:    #F5F6F8;
...
.ev {
  ...
  &__status {
    ...
    &[data-state='draft']::before  { background: $signal; box-shadow: 0 0 0 3px rgba($signal, 0.18); }
    &[data-state='live'] { color: $signal; border-color: rgba($signal, 0.35); }
  ...
  &__manifest-title {
    ...
    color: $ink;
    line-height: 1.15;
    // shows the live run name once typed
    white-space: nowrap;
    overflow: hidden;
  ...
  &__spec-row--todo { opacity: 0.9; } // base state placeholder (keeps class defined)
  ...
  &__btn {
    ...
    &--primary {
      ...
      color: #fff;
      box-shadow: $soft;
      &:not(:disabled):hover { background: #000; transform: translateY(-1px); box-shadow: $lift; }
    }
  ...
  &__input {
    ...
    &::placeholder { color: #B7BCC5; font-weight: 400; }
  ...
  &__name-input {
    ...
    &::placeholder { color: #C7CBD2; font-weight: 700; }
  ...
  &__mcard-provider { font-size: 0.71875rem; color: $ink-3; margin-top: 2px; }
...
@keyframes ev-pulse {
  0%, 100% { box-shadow: 0 0 0 0 rgba($signal, 0.5); }
  50% { box-shadow: 0 0 0 4px rgba($signal, 0); }
}
@keyframes ev-rise {
