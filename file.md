...
{
  "_comment": "Add this 'tour' block inside the existing 'settings' object in en.json",
  "tour": {
    "step1Title": "Your dictionaries",
    "step1Body": "All your saved dictionaries live here. Select one to view and edit it, or create a new one with the + button at the top.",
    "step2Title": "Create a dictionary",
    "step2Body": "Click + to start a new dictionary. You can have multiple dictionaries — for example one per course or subject area.",
    "step3Title": "Name your dictionary",
    "step3Body": "Give it a clear, descriptive name (up to 255 characters). The name appears in the list panel and in any pipeline that uses this dictionary.",
    "step4Title": "Add correction terms",
    "step4Body": "Click \"Add term\" to insert a new row. Each row maps one wrong form to its correct replacement — you can add as many as you need.",
    "step5Title": "Wrong → Correct pairs",
    "step5Body": "Type the misspelled or incorrect form in the left column and the replacement in the right. The delete button removes a row. Use the search bar above to filter when the list is long.",
    "step6Title": "Save your dictionary",
    "step6Body": "Hit \"Create\" (new) or \"Save changes\" (existing) to persist your work. The dictionary is applied automatically during STT transcription and inference runs."
  }
}
...
{
  "_comment": "Add this 'tour' block inside the existing 'settings' object in ko.json",
  "tour": {
    "step1Title": "내 사전 목록",
    "step1Body": "저장된 모든 사전이 여기에 표시됩니다. 클릭하여 보거나 편집하고, 상단의 + 버튼으로 새 사전을 만들 수 있습니다.",
    "step2Title": "사전 만들기",
    "step2Body": "+ 버튼을 클릭하여 새 사전을 만드세요. 강의 또는 주제 영역별로 여러 개의 사전을 만들 수 있습니다.",
    "step3Title": "사전 이름 지정",
    "step3Body": "사전에 명확하고 설명적인 이름을 입력하세요(최대 255자). 이름은 목록 패널과 이 사전을 사용하는 파이프라인에 표시됩니다.",
    "step4Title": "교정 용어 추가",
    "step4Body": "\"항목 추가\"를 클릭하여 새 행을 추가하세요. 각 행은 잘못된 형태를 올바른 교정어로 매핑합니다 — 필요한 만큼 추가할 수 있습니다.",
    "step5Title": "잘못된 용어 → 올바른 용어 쌍",
    "step5Body": "왼쪽 열에 잘못된 형태를, 오른쪽 열에 교정어를 입력하세요. 삭제 버튼으로 행을 제거할 수 있습니다. 목록이 길어지면 위의 검색창으로 필터링하세요.",
    "step6Title": "사전 저장",
    "step6Body": "\"생성\"(신규) 또는 \"변경사항 저장\"(기존)을 눌러 작업을 저장하세요. 저장된 사전은 STT 전사 및 추론 실행 시 자동으로 적용됩니다."
  }
}
