...
import { ArrowLeft, ArrowRight, Play, Check, SlidersHorizontal, Clock3 } from 'lucide-react';
...
.run-eval {
  ...
  &__header {
    ...
    padding: 20px 24px;
    margin-bottom: 20px;
    background: linear-gradient(135deg, $primary-light 0%, $bg-main 55%);
  ...
  &__header-icon {
    ...
    display: grid;
    place-items: center;
    box-shadow: 0 4px 14px -4px rgba(20, 40, 160, 0.45);
  }
