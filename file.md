{
  ...
  "uploadInfer": {
    ...
    "tour": {
      ...
      "pageTitleTitle": "Welcome to LectureAI",
      "pageTitleBody": "Let's walk through how to upload lecture captions, run inference on them, and browse the results — step by step.",
      "tabUploadTitle": "Upload & Manage",
      "tabUploadBody": "This is where you add new files and manage everything you've already uploaded.",
      "section2TitleRowTitle": "Your file list",
      "section2TitleRowBody": "Everything you've uploaded shows up below, with its count, sorting, and date range controls right here at the top.",
      "filterSortRowTitle": "Filter and bulk actions",
      "filterSortRowBody": "Status filtering and every bulk action — Dictionary, Prompt Template, Search, Export, and Delete — live in this row.",
      "uploadedBodyTitle": "Your uploaded files",
      "cardsSingleBody": "Here's one of your files. Let's look at the small prompt icons below its name, one by one.",
      "tabInferTitle": "Inference",
      "tabInferBody": "Once files are uploaded, come here to choose which of them to analyze and what to generate.",
      "inferFileListTitle": "Check off files",
      "inferFileListBody": "Tick the checkbox on however many files you want to run inference on together — they'll all use the same settings below.",
      "tabResultsTitle": "View Results",
      "tabResultsBody": "Once a file's finished processing, come here to browse everything that was generated for it.",
      "resultsFileListTitle": "Your finished files",
      "resultsFileListBody": "Every file that's been through inference shows up here — click one to load its results on the right. If nothing's finished yet, this list will simply be empty for now.",
...

{
  ...
  "uploadInfer": {
    ...
    "tour": {
      ...
      "pageTitleTitle": "LectureAI에 오신 것을 환영합니다",
      "pageTitleBody": "강의 자막을 업로드하고, 추론을 실행하고, 결과를 확인하는 과정을 단계별로 함께 살펴보겠습니다.",
      "tabUploadTitle": "업로드 및 관리",
      "tabUploadBody": "새 파일을 추가하고, 이미 업로드한 파일들을 관리하는 곳입니다.",
      "section2TitleRowTitle": "파일 목록",
      "section2TitleRowBody": "업로드한 모든 파일이 아래에 표시되며, 상단에서 개수 확인, 정렬, 날짜 범위 설정을 바로 할 수 있습니다.",
      "filterSortRowTitle": "필터 및 일괄 작업",
      "filterSortRowBody": "상태 필터와 사전, 프롬프트 템플릿, 검색, 내보내기, 삭제 등 모든 일괄 작업이 이 행에 모여 있습니다.",
      "uploadedBodyTitle": "업로드한 파일 목록",
      "cardsSingleBody": "파일 중 하나입니다. 파일명 아래의 작은 프롬프트 아이콘들을 하나씩 살펴보겠습니다.",
      "tabInferTitle": "추론",
      "tabInferBody": "파일을 업로드한 후에는 여기에서 분석할 파일과 생성할 항목을 선택하세요.",
      "inferFileListTitle": "파일 선택하기",
      "inferFileListBody": "함께 추론을 실행할 파일들의 체크박스를 선택하세요 — 선택한 파일들은 아래의 동일한 설정을 사용합니다.",
      "tabResultsTitle": "결과 보기",
      "tabResultsBody": "파일 처리가 완료되면 여기에서 생성된 모든 결과를 확인할 수 있습니다.",
      "resultsFileListTitle": "완료된 파일 목록",
      "resultsFileListBody": "추론이 완료된 파일들이 모두 여기에 표시됩니다 — 파일을 클릭하면 오른쪽에서 결과를 확인할 수 있습니다. 아직 완료된 파일이 없다면 이 목록은 비어 있습니다.",
