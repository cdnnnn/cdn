...
const CompareSide: React.FC<{
    ...
    accent: 'from' | 'to';
}> = ({ data, loading, error, section, accent }) => {
    const { t } = useTranslation();
        ...
        <div className={`${styles.compareOverlay} ${open ? styles.compareOverlayOpen : ''}`} aria-hidden={!open}>
            ...
            <div className={`${styles.compareDrawer} ${open ? styles.compareDrawerOpen : ''}`} role="dialog" aria-modal="true">
                ...
                <div className={styles.compareBody}>
                    <CompareSide data={fromData} loading={fromLoading} error={fromError} section={section} accent="from" />
                    <div className={styles.compareDivider} />
                    <CompareSide data={toData} loading={toLoading} error={toError} section={section} accent="to" />
                </div>
            </div>
        </div>
    );
