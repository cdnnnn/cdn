                        ...
                        <div className={styles.compareSideActions}>
                            <button type="button" className={styles.compareSideActionBtn} onClick={() => setCreateTemplateOpen(true)}>
                                <svg viewBox="0 0 14 14" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round">
                                    <path d="M3 2.5h8v9H3z" /><path d="M5.5 5.5h3M5.5 7.5h3M7 10.5v-6M7 4.5v.01" />
                                </svg>
                            ...
                            <button type="button" className={styles.compareSideActionBtn} onClick={() => setUpdatePromptsOpen(true)}>
                                <svg viewBox="0 0 14 14" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round">
                                    <path d="M12.5 7A5.5 5.5 0 111 5.6" /><path d="M12.5 2.5V6H9" />
                                </svg>
...
//en.json
{
  ...
  "uploadInfer": {
    ...
    "workspacePanel": {
      ...
      "createTemplateTitle": "Save as New Template",
      "createTemplateSub": "From {{name}}\u2019s prompts",
      "templateNameLabel": "Name",
      "templateNamePlaceholder": "e.g. Lecture Summary v2",
      "templateNameRequired": "Template name is required.",
      "templateDescLabel": "Description",
      "templateDescPlaceholder": "What is this template for?",
      "templatePromptsPreview": "Prompts included (from this version)",
      "templateCreateFail": "Could not create the template. Please try again.",
      "templateCreated": "Template created.",
      "updatePromptsBtn": "Update Prompts",
      "updatePromptsTitle": "Update File\u2019s Prompts",
      "updatePromptsSub": "From {{name}}",
      "updatePromptsHint": "Choose which prompts to copy from this version onto the file\u2019s default prompts. Anything left unchecked stays as-is.",
      "updatePromptsNoneSelected": "Pick at least one prompt to update.",
      "updatePromptsFail": "Could not update the file\u2019s prompts. Please try again.",
...
//ko.json
{
  ...
  "uploadInfer": {
    ...
    "workspacePanel": {
      ...
      "createTemplateBtn": "템플릿 생성",
      "createTemplateTitle": "새 템플릿으로 저장",
      "createTemplateSub": "{{name}}의 프롬프트에서 생성",
      "templateNameLabel": "이름",
      "templateNamePlaceholder": "예: 강의 요약 v2",
      "templateNameRequired": "템플릿 이름은 필수입니다.",
      "templateDescLabel": "설명",
      "templateDescPlaceholder": "이 템플릿은 어떤 용도인가요?",
      "templatePromptsPreview": "포함된 프롬프트 (이 버전 기준)",
      "templateCreateFail": "템플릿을 생성할 수 없습니다. 다시 시도해 주세요.",
      "templateCreated": "템플릿이 생성되었습니다.",
      "updatePromptsBtn": "프롬프트 업데이트",
      "updatePromptsTitle": "파일의 프롬프트 업데이트",
      "updatePromptsSub": "{{name}} 기준",
      "updatePromptsHint": "이 버전에서 파일의 기본 프롬프트로 복사할 항목을 선택하세요. 선택하지 않은 항목은 그대로 유지됩니다.",
      "updatePromptsNoneSelected": "업데이트할 프롬프트를 하나 이상 선택하세요.",
      "updatePromptsFail": "파일의 프롬프트를 업데이트할 수 없습니다. 다시 시도해 주세요.",
      "promptsUpdated": "프롬프트가 업데이트되었습니다.",
      "edit": "편집",
      "copy": "복사",
      "download": "다운로드",
      "copyAs": "형식으로 복사",
