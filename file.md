...

{
  ...
  "uploadInfer": {
    ...
    "workspacePanel": {
      ...
      "importanceHint": "\"6/10\" is how important the keyword is to the file; \"3× freq\" is how many times it appears.",
      "kiTabs": {
...

{
  ...
  "uploadInfer": {
    ...
    "workspacePanel": {
      ...
      "importanceAxis": "중요도",
      "importanceHint": "\"6/10\"은 이 키워드가 파일에서 얼마나 중요한지를 나타내고, \"빈도 3회\"는 언급된 횟수를 나타냅니다.",
      "kiTabs": {
        "graph": "지식 그래프",
        "wordcloud": "워드 클라우드",
        "timeline": "타임라인",
