...
export const usageApi = {
  // GET /usage/openrouter/credits — OpenRouter-specific credit balance,
  // surfaced on the OpenRouter provider's card in the Providers grid.
  getOpenRouterCredits: () =>
    api.get<OpenRouterCreditsResponse>('/usage/openrouter/credits').then((r) => r.data),
};
